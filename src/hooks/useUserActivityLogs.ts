...
export const actionTypeLabels: Record<string, string> = {
  ...
  permit_cancel: 'Permit Cancelled',
  permit_amend: 'Permit Schedule Changed',
  permit_amend_requested: 'Extension Requested',
  permit_amend_approved: 'Extension Approved',
  permit_amend_rejected: 'Extension Rejected',
