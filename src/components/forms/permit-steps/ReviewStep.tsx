 ...
 *
 * PDF preview was intentionally removed from this step — users now only
 * see/download the PDF after the permit has been submitted (and, for
 * tenant-only users, after final approval).
 */
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {data.backOfHouse
              ? `${t('permits.form.backOfHouse')} — ${t('permits.form.floor')} ${data.floor}`
